...
export default {
  ...
  methods: {
    ...
    async editAnswer() {
      ...
      this.loading = true;
      try {
        await this.$store.dispatch("questions/editAnswer", {
          body: this.body,
        ...
        this.body = "";
        this.close();
        this.$toast.success("Your Answer has been updated successfully");
      } catch (error) {
        if (error.response.status == 422) {
          this.errors = error.response.data.errors;
        }
      } finally {
        this.$store.dispatch("questions/fetchAnswers", this.question.id);
        this.loading = false;
      }
    },
  },
